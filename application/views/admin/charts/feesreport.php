...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo $baseUrl; ?>reports">Profit & Loss Charts</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Fees Paid By Members</h3>
            </div>
                <div class="chartfilters">
                    <form method="post" action="" autocomplete="off">
                    <div class=" col-sm-4">
                        <input type="text" class="form-control datepicker" value="<?php if(isset($_POST['startdate2']) && !empty($_POST['startdate2'])){ echo $_POST['startdate2']; } ?>" id="startdatereportsfilt1" name="startdate2" placeholder="Please Select Start Date">
                    </div>
                    <div class=" col-sm-4">
                        <input type="text" class="form-control datepicker" value="<?php if(isset($_POST['enddate2']) && !empty($_POST['enddate2'])){ echo $_POST['enddate2']; } ?>" id="enddatereportsfilt1" name="enddate2" placeholder="Please Select End Date">
                    </div>
                    <div class="col-sm-2">
            ...
            <div class="box-body">
              ...
              <table id="feesreporttable" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>Name</th>
                  <th>Phone</th>
                ...
                <tbody>
                    <?php foreach($feesmembers as $member){ $lastindex=sizeof($member['fees_detail'])-1; ?>
                <tr>
                  <td><?php echo $member['name']; ?></td>
                  <td><?php echo $member['phone']; ?></td>
                  <td><?php if(isset($member['gender']) && $member['gender']!=""){echo $member['gender'];} else{echo "N/A";} ?></td>
<td><?php if(isset($member['fees_detail'][$lastindex]['fees'])){ echo $this->session->userdata['currency_symbol']."".$member['fees_detail'][$lastindex]['fees']; }else{ echo $this->session->userdata['currency_symbol']."0"; } ?></td>
                    <!--
