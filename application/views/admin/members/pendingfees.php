                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($this->session->userdata['referncenumber_status']==true){ if($member['refrence_no']==''){ ?>
                                    ...
                                    <?php }} ?>
                            <td class="memimg"><div class="listingprofileimg"><img class="" src="<?php if(isset($member['image']) && $member['image']!=""){echo site_url('uploads/thumb/'.$member['image']);} else{echo site_url('frontend/images/noimage.jpg');} ?>"></div></td>
